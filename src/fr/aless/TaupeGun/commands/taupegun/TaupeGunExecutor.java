...
public class TaupeGunExecutor implements CommandExecutor, TabCompleter {
        ...
        if (!(sender instanceof Player)) {
            try {
                ...
                if (args[0].equalsIgnoreCase("list"))
                    return new fr.aless.TaupeGun.commands.taupegun.List(this).handle(sender);
            ...
            try {
                ...
                if (args[0].equalsIgnoreCase("list"))
                    return new fr.aless.TaupeGun.commands.taupegun.List(this).handle(player);
                if (args[0].equalsIgnoreCase("reload"))
    ...
    public List<String> onTabComplete(CommandSender commandSender, Command command, String s, String[] args) {
        if (args.length == 1) {
            final String[] completions0 = {"addplayer", "list", "reload", "removeplayer", "spawn", "start", "stop"};
